...
def load_data():
    ...
    data["Status"].replace(to_replace=["FID/Construction", "FID", "Construction"],value="Under Construction")
    data["Status"].replace(to_replace=["Other/Unknown", "Unknown"],value="Other")
